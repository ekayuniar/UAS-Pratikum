...
<html lang="en">
    ...
    <body id="page-top">
	  ...
	  <li class="nav-item active">
		<a class="nav-link" href="tambah_data.php">Input Barang Masuk <span class="sr-only">(current)</span></a>
	  <li class="nav-item active">
		<a class="nav-link" href="tampil_data2.php">Jumblah Barang Masuk <span class="sr-only">(current)</span></a>
      </li>
                    </ul>
                </div>
            </div>
